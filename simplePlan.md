...
- [x] Show a curated IRCC document checklist and collect applicant details needed for draft generation.
...
- The applier feature will follow the same pattern: demo-first in Next.js, with a same-repo worker seam for later real PDFium/XFA support.
